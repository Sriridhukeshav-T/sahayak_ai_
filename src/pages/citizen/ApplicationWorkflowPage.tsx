  ...
  const handleNext = () => {
    if (step < 5) {
      ...
      submitApplication({
        ...
        timeline: [
          { status: 'SUBMITTED', title: 'Application Recorded in SSahayaka', description: 'Application registered as user-reported on platform.', timestamp: new Date().toISOString(), completed: true, current: true, statusOrigin: 'USER_REPORTED' },
